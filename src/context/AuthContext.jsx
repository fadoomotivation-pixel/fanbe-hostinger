  ...
  useEffect(() => {
    ...
    getSessionWithTimeout(15000).then(async ({ data: { session }, error }) => {
      ...
      if (error?.message === 'timeout') {
        ...
        // let the user land on /login normally; the onAuthStateChange
        // subscription set up below will pick them up via INITIAL_SESSION
        // once the SDK eventually resolves.
