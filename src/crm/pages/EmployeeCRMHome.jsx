...
const EmployeeCRMHome = () => {
  ...
  // Browser-notification permission: ask once on first mount so follow-ups
  // and 15-min pre-warnings can fire from useFollowUpNotifications below
  // even when the employee's tab is in the background.
  useEffect(() => {
  ...
  // Schedule browser notifications for each lead's follow-up time
  // (and a 15-min pre-warning). Re-runs whenever myLeads changes.
