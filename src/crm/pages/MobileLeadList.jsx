...
import { Search, Phone, ChevronRight, Flame, Wind, Snowflake, AlertCircle, Filter, Users } from 'lucide-react';
...
import { normalizeLeadStatus, normalizeInterestLevel, getStatusColor, LEAD_STATUS } from '@/crm/utils/statusUtils';
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map(lead => {
            ...
            return (
              <div
                key={lead.id}
                className={`bg-white rounded-xl shadow-sm border active:scale-[0.99] transition-transform ${
