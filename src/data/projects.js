// ✅ RATES, BOOKING % & EMI DURATIONS UPDATED — Feb 20, 2026
...
const projects = [
  ...
  },
  {
    ...
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '10%', installments: '54 months interest-free', registryOn: '10% payment' }
    ],
    images: [
  ...
  },
  {
    ...
    highlights: ['Located in Sacred Braj Region', 'Fully Developed Infrastructure', 'Clear Documentation', 'Registry on 30% Payment', 'No Brokerage', 'Direct from Developer'],
    pricing: {
    ...
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '10%', installments: '40 months interest-free', registryOn: '30% payment' }
    ],
    images: [
  ...
  },
  {
    ...
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '10%', installments: '24 months interest-free', registryOn: '35% payment' }
    ],
    images: [
  ...
  },
  {
    ...
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '15%', installments: '24 months interest-free', registryOn: '40% payment' }
    ],
    images: [
