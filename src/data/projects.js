// ✅ RATES, BOOKING % & EMI DURATIONS UPDATED — Feb 2026
// Base plot size for starting price display: 50 sq yd
//
// Project                  Rate      Booking%  EMI Duration
// Shree Kunj Bihari        ₹7,525    10%       60 months
// Shri Khatu Shyam         ₹7,525    10%       60 months
// Gokul Vatika             ₹10,025   35%       24 months
// Maa Semri Vatika         ₹15,525   35%       24 months
// Jagannath Dham           ₹8,025    12.5%     54 months
// Brij Vatika (E Block)    ₹15,525   35%       40 months
...
const projects = [
  {
    ...
    pricing: {
      ...
      emiMonths: 60,
      plotSizes: ['50 sq yd', '100 sq yd', '150 sq yd', '200 sq yd', '250 sq yd']
    },
    amenities: ['Underground Electricity', 'Street Lights', 'Water Supply', 'Drainage System', 'Boundary Wall', 'Main Gate with Security', 'Children Play Area', 'Community Hall', 'Temple'],
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '10%', installments: '60 months interest-free', registryOn: '10% payment' }
    ],
    images: [
    ...
    mapLocation: { lat: 27.5801, lng: 77.7000, embedUrl: 'https://www.openstreetmap.org/export/embed.html?bbox=77.6900%2C27.5700%2C77.7100%2C27.5900&layer=mapnik' }
  },
  {
    ...
    pricing: {
      ...
      bookingPctDisplay: '10%',
      emiMonths: 60,
      plotSizes: ['50 sq yd', '100 sq yd', '150 sq yd', '200 sq yd']
    },
    amenities: ['Paved Roads', 'Street Lighting', 'Water Connection', 'Electricity Connection', 'Sewage System', 'Landscaped Garden', 'Security Guards', 'CCTV Surveillance'],
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '10%', installments: '60 months interest-free', registryOn: '10% payment' }
    ],
    images: [
    ...
    mapLocation: { lat: 27.3000, lng: 74.9500, embedUrl: 'https://www.openstreetmap.org/export/embed.html?bbox=74.9400%2C27.2900%2C74.9600%2C27.3100&layer=mapnik' }
  },
  {
    ...
    amenities: ['Wide Roads - 40ft & 60ft', 'Underground Cabling', 'Street Lights', 'Bore Water Supply', 'Drainage System', 'Park & Green Areas', 'Community Center', '24x7 Security'],
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '12.5%', installments: '54 months interest-free', registryOn: '12.5% payment' }
    ],
    images: [
    ...
    mapLocation: { lat: 27.4924, lng: 77.6737, embedUrl: 'https://www.openstreetmap.org/export/embed.html?bbox=77.6637%2C27.4824%2C77.6837%2C27.5024&layer=mapnik' }
  },
  {
    id: 'brij-vatika',
    ...
    highlights: ['Located in Sacred Braj Region', 'Fully Developed Infrastructure', 'Clear Documentation', 'Registry on 35% Payment', 'No Brokerage', 'Direct from Developer'],
    pricing: {
    ...
    amenities: ['Concrete Roads', 'Solar Street Lights', 'RO Water Plant', 'Electricity Meters', 'Sewerage System', 'Landscaping', 'Children Park', 'Security Cabin'],
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '35%', installments: '40 months interest-free', registryOn: '35% payment' }
    ],
    images: [
    ...
    mapLocation: { lat: 27.5167, lng: 77.6833, embedUrl: 'https://www.openstreetmap.org/export/embed.html?bbox=77.6733%2C27.5067%2C77.6933%2C27.5267&layer=mapnik' }
  },
  {
    ...
    amenities: ['60ft Wide Main Road', 'Interlocking Tile Roads', 'LED Street Lights', 'Underground Water Tank', 'Electricity Connection', 'Sewerage Line', 'Meditation Center', 'Jogging Track', 'Gated Entry'],
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '35%', installments: '24 months interest-free', registryOn: '35% payment' }
    ],
    images: [
    ...
    mapLocation: { lat: 27.4400, lng: 77.7200, embedUrl: 'https://www.openstreetmap.org/export/embed.html?bbox=77.7100%2C27.4300%2C77.7300%2C27.4500&layer=mapnik' }
  },
  {
    id: 'maa-semri-vatika',
    ...
    highlights: ['High Appreciation Zone', 'Near NH-2 Connectivity', 'Approved by Local Authority', 'Transparent Pricing', 'No Extra Charges', 'Quick Registry Process'],
    pricing: {
      startingPrice: '\u20b97,76,250',
      pricePerSqYd: '\u20b915,525',
      pricePerSqYdNum: 15525,
    ...
    amenities: ['Paved Internal Roads', 'Street Lighting', 'Water Supply', 'Electricity Poles', 'Boundary Wall', 'Main Gate', 'Green Belt', 'Open Spaces'],
    paymentPlans: [
      { name: 'Standard Plan', downPayment: '35%', installments: '24 months interest-free', registryOn: '35% payment' }
    ],
    images: [
    ...
    mapLocation: { lat: 27.5500, lng: 77.6500, embedUrl: 'https://www.openstreetmap.org/export/embed.html?bbox=77.6400%2C27.5400%2C77.6600%2C27.5600&layer=mapnik' }
  }
];
