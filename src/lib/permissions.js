...
const PERMISSIONS = {
  [ROLES.SUPER_ADMIN]: {
    ...
    canManageSettings: true, canViewAllLeads: true, canViewAllPerformance: true,
    canViewDailyReports: true, canViewGlobalAnalytics: true, canDeleteRecords: true,
    canViewPasswords: true, canManageTeams: true, canAssignLeads: true,
  },
  [ROLES.MANAGER]: {
    canManageContent: false, canManageStaff: true, canManageSubAdmins: false,
    canManageSettings: false, canViewAllLeads: false, canViewAllPerformance: true,
    canViewDailyReports: true, canViewGlobalAnalytics: false, canDeleteRecords: false,
    canViewPasswords: false, canManageTeams: true, canAssignLeads: true,
  },
  [ROLES.SUB_ADMIN]: {
    canManageContent: false, canManageStaff: false, canManageSubAdmins: false,
    canManageSettings: false, canViewAllLeads: false, canViewAllPerformance: false,
    canViewDailyReports: true, canViewGlobalAnalytics: true, canDeleteRecords: false,
    canViewPasswords: false, canManageTeams: false, canAssignLeads: false,
  },
  [ROLES.SALES_EXECUTIVE]: {
    ...
    canViewPasswords: false, canManageTeams: false, canAssignLeads: false,
    canScheduleSiteVisits: true, canCreateBookings: true,
  },
  [ROLES.TELECALLER]: {
    canManageContent: false, canManageStaff: false, canManageSubAdmins: false,
    canManageSettings: false, canViewAllLeads: false, canViewAllPerformance: false,
    canViewDailyReports: false, canViewGlobalAnalytics: false, canDeleteRecords: false,
    canViewPasswords: false, canManageTeams: false, canAssignLeads: false,
    canScheduleSiteVisits: false, canCreateBookings: false,
    canMakeCalls: true, canScheduleAppointments: true,
  }
};
