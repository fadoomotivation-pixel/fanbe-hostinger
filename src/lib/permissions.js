...
const MENU_STRUCTURE = {
  [ROLES.SUPER_ADMIN]: [
    ...
    { label: 'Re-assign Leads',       path: '/crm/admin/reassign-leads',         icon: 'RefreshCw' },
  ...
  // ✅ SIMPLIFIED Employee Menu — 6 items, My CRM first
  [ROLES.SALES_EXECUTIVE]: [
    { label: '📞 My CRM',    path: '/crm/sales/crm',                  icon: 'PhoneCall' },
